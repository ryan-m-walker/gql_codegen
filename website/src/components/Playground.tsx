// Browser polyfills - MUST be before an graphql-codegen imports
...
export default function Playground() {
    ...
    const [codegenResult, setCodegenResult] = useState<GenerationResult | null>(
        null,
    )
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                handlePresetChange(e.target.value as Preset)
                            }
                                        ...
                                        <div className="space-y-2">
                                            {currentResult?.warnings.map(
                                                (warning, i) => (
                                                    <pre
                                                        key={i}
                                                        className="text-yellow-300 whitespace-pre-wrap bg-yellow-950/30 rounded p-3 border border-yellow-900/50"
                                                    >
                                                        {warning}
                                                    </pre>
                                                ),
